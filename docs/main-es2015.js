...
let AuthUIComponent = class AuthUIComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
let BookComponent = class BookComponent {
    constructor(route, db, clipboard, _snackBar) {
        this.route = route;
        this.db = db;
...
let ClipboardSnackbarComponent = class ClipboardSnackbarComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
let ExcerptComponent = class ExcerptComponent {
    constructor(sanitizer, md) {
...
ExcerptComponent.ctorParameters = () => [
...
let LoginUIDirective = class LoginUIDirective {
    constructor(el) {
    }
};
LoginUIDirective.ctorParameters = () => [
...
let NewItemDialogComponent = class NewItemDialogComponent {
...
NewItemDialogComponent.ctorParameters = () => [
...
let RemoveBottomSheetComponent = class RemoveBottomSheetComponent {
...
RemoveBottomSheetComponent.ctorParameters = () => [
...
let SectionComponent = class SectionComponent {
    constructor(dialog, bottomSheet, db, clipboard, router, _snackBar) {
        this.dialog = dialog;
    ...
    addClick() {
        const dialogRef = this.dialog.open(_new_item_dialog_new_item_dialog_component__WEBPACK_IMPORTED_MODULE_3__["NewItemDialogComponent"], {
            width: '80%',
            data: { name: '' }
        });
    ...
    openBottomSheet() {
        const ref = this.bottomSheet.open(_remove_bottom_sheet_remove_bottom_sheet_component__WEBPACK_IMPORTED_MODULE_6__["RemoveBottomSheetComponent"]);
...
let StaticDBService = class StaticDBService {
    constructor(http) {
        this.http = http;
    ...
    getJson(sha) {
        return this.http.get('assets/db/' + sha + '.json').toPromise().then(obj => {
            const instance = Object.assign(new _Node(), obj);
            return instance;
        });
    }
    getHome() {
...
StaticDBService.ctorParameters = () => [
